...
| Accessibility | IME; TalkBack key labels are in a separate open PR, not this tree. |
...
| --- | --- | --- |
| `minSdk` | 24 | OK |
| `targetSdk` / `compileSdk` | **34** | **Phone/tablet new apps and updates must target API 36.** This is a listing blocker until a dedicated SDK bump PR. |
